...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/dining/al-fresco`, lastModified, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/dining/cafe`, lastModified, changeFrequency: 'monthly', priority: 0.7 },
